...
/**
 *
 * Test for issue: https://issues.jboss.org/browse/JBEAP-10449
...
@RunAsClient
@ServerSetup({JBEAP10449TestCase.PropertyFilesSetup.class, JBEAP10449TestCase.SecurityDomainsSetup.class})
public class JBEAP10449TestCase {
    ...
    public static WebArchive deploymentIdP() {
        ...
        identityProvider.addAsWebResource(JBEAP10449TestCase.class.getResource("JBEAP10449/idp/idp-metadata.xml"), "WEB-INF/picketlink.xml");

        identityProvider.addAsWebInfResource(JBEAP10449TestCase.class.getResource("JBEAP10449/idp/web.xml"), "web.xml");

        identityProvider.addAsWebResource(JBEAP10449TestCase.class.getResource("JBEAP10449/idp/login.jsp"), "jsp/login.jsp");

        identityProvider.addAsWebInfResource(new StringAsset("<jboss-web>" + //
                "<security-domain>JBEAP-10449-idp</security-domain>" + //
    ...
    public static WebArchive deploymentSP() {
        ...
        serviceProvider.addAsWebResource(JBEAP10449TestCase.class.getResource("JBEAP10449/sp/post-test-main.jsp"), "freezone/post-test-main.jsp");
        serviceProvider.addAsWebResource(JBEAP10449TestCase.class.getResource("JBEAP10449/sp/mf-post-test.jsp"), "freezone/mf-post-test.jsp");
        serviceProvider.addAsWebResource(JBEAP10449TestCase.class.getResource("JBEAP10449/sp/index.jsp"), "index.jsp");
        serviceProvider.addAsWebInfResource(JBEAP10449TestCase.class.getResource("JBEAP10449/sp/web.xml"), "web.xml");
        ...
        serviceProvider.addAsWebInfResource(new StringAsset("<jboss-web>" + //
                "<security-domain>JBEAP-10449-sp</security-domain>" +
                "<valve><class-name>org.picketlink.identity.federation.bindings.tomcat.sp.ServiceProviderAuthenticator</class-name></valve>" +
                "</jboss-web>"), "jboss-web.xml");
        serviceProvider.addAsWebResource(JBEAP10449TestCase.class.getResource("JBEAP10449/sp/sp-metadata.xml"), "WEB-INF/picketlink.xml");
    ...
    static class SecurityDomainsSetup extends AbstractSecurityDomainsServerSetupTask {
        ...
        protected SecurityDomain[] getSecurityDomains() {
            ...
            final SecurityDomain idp = new SecurityDomain.Builder().name("JBEAP-10449-idp").loginModules(loginModuleBuilder.build()).build();
            ...
            final SecurityDomain sp = new SecurityDomain.Builder().name("JBEAP-10449-sp").loginModules(samlLoginModuleBuilder.build())
                    .build();
