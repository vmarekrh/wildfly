...
public class JaxrsAppTest {
    ...
    public static Archive<?> deploySimpleResource() {
        WebArchive war = ShrinkWrap.create(WebArchive.class, JaxrsAppTest.class.getSimpleName() + ".war");
        war.addAsWebInfResource(JaxrsAppTest.class.getPackage(), "JaxrsAppWeb.xml", "web.xml");
