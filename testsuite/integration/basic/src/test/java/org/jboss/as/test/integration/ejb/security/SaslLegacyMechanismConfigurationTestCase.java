...
public class SaslLegacyMechanismConfigurationTestCase extends AbstractCliTestBase {
   ...
   public static class LegacyMechanismConfigurationSetupTask implements ServerSetupTask {
      ...
      public void tearDown(ManagementClient managementClient, String containerId) throws Exception {
         ...
         if(propsAuthentication != null) {
            compositeOperation.get(ModelDescriptionConstants.STEPS).add(Operations.createUndefineAttributeOperation(AUTHENTICATION_PROPS.toModelNode(),"plain-text"));
            compositeOperation.get(ModelDescriptionConstants.STEPS).add(Operations.createUndefineAttributeOperation(AUTHENTICATION_PROPS.toModelNode(),"relative-to"));
            for (String attribute : propsAuthentication.keys() ) {
               compositeOperation.get(ModelDescriptionConstants.STEPS).add(Operations.createWriteAttributeOperation(AUTHENTICATION_PROPS.toModelNode(), attribute, propsAuthentication.get(attribute).asString()));
            }
         }
         if(saslAuthenticationFactory != null) {
            compositeOperation.get(ModelDescriptionConstants.STEPS).add(Operations.createWriteAttributeOperation(HTTP_REMOTING_CONNECTOR.append().toModelNode(), "sasl-authentication-factory", saslAuthenticationFactory));
         }
