...
class SecurityManagerSubsystemAdd extends AbstractBoottimeAddStepHandler {
    ...
    protected void installProcessors(final OperationContext context, final ModelNode node)
        ...
        final ModelNode deploymentPermissionsNode = node.get(DEPLOYMENT_PERMISSIONS_PATH.getKeyValuePair());
        final ModelNode minimumPermissionsNode = MINIMUM_PERMISSIONS.resolveModelAttribute(context, deploymentPermissionsNode);
        ...
        ModelNode maximumPermissionsNode = MAXIMUM_PERMISSIONS.resolveModelAttribute(context, deploymentPermissionsNode);
