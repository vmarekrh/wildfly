...
of Java EE application's deployments, that is, `.ear` files and configuration of global directories to share common libraries across all deployed applications.
